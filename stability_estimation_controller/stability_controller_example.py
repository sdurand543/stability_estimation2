...
def main(argv):
  ...
  action_initial = np.copy(joint_angles_end) #= np.array([-0.15, 0.9, -2 * 0.9] + [0.15, 0.9, -2 * 0.9] + [-0.15, 0.7, -2 * 0.9] + [0.15, 0.7, -2 * 0.9])#np.array([0., 1.2, -2 * 1.2] + [0.15, 0.9, -2 * 0.9] + [0.0, 1, -2 * 0.9] + [0.15, 1, -2 * 0.9])
  ...
  joint_angles_end = np.copy(action_final)
  #joint_angles_curr, contact = actuate_joint_angles(joint_angles_curr, joint_angles_end, 5000)

  #joint_angles_end = np.array([0.3, 0.9, -2 * 0.9] + [0.3, 0.9, -2 * 0.9] + [0.3, 0.9, -2 * 0.9] + [0.3, 0.9, -2 * 0.9])
  ...
  joint_angles_curr, contact = actuate_joint_angles(joint_angles_curr, joint_angles_end, 1000)
