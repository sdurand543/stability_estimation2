...
from stability_estimation_controller import a1_sim as robot_sim
...
_INIT_LEG_STATE = (
    gait_generator_lib.LegState.STABLE_STANCE,
    gait_generator_lib.LegState.STABLE_STANCE,
    gait_generator_lib.LegState.STABLE_STANCE,
    gait_generator_lib.LegState.STABILITY_ESTIMATION,
)
