...
class RaibertSwingLegController(leg_controller.LegController):
  ...
  """
    ...
    def get_action(self) -> Mapping[Any, Any]:
        ...
        roll_dot, pitch_dot, yaw_dot = self._robot.GetBaseRollPitchYawRate()
        ...
        for leg_id, leg_state in enumerate(self._gait_generator.leg_state):
            ...
            foot_target_position = - self._desired_height + np.array((hip_offset[0], hip_offset[1], 0))

            # foot_target_position[1] = 0
            # if (leg_id == 0 or leg_id == 2):
            #     foot_target_position[0] -= 0.02
